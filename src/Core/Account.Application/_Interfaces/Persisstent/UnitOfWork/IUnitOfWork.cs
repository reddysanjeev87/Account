namespace Account.Application
{
    ...
    public interface IUnitOfWork : IDisposable
    {
        ...
        TRepo GetChildRepository<TRepo>() where TRepo : class;
        ...
        Task<IEnumerable<dynamic>> GetDynamicFromRawSqlAsync(string query, object[] parameters = null);
        Task<List<TEntity>> GetFromRawSqlAsync<TEntity>(string query, object[] parameters = null) where TEntity : class;
        Task<List<TEntity>> GetFromStoredProcedureAsync<TEntity>(string query, object[] parameters = null) where TEntity : class;
